...
print(put('http://127.0.0.1:5000/api/v2/user/1',
...
print(post('http://127.0.0.1:5000/api/v2/users',
           json={"address": "TARDIS", "age": 1821, "email": "123@mars.org", "hashed_password": None,
                 "modified_date": None, "name": "WHO", "position": "solder", "speciality": None,
                 "surname": "DOCTOR"}).json())
print(get('http://127.0.0.1:5000/api/v2/user/2').json())
